...
seconds = 10 # seconds that the device is sleeping
...
dev_addr = struct.unpack(">l", ubinascii.unhexlify('260C736B'))[0]
nwk_swkey = ubinascii.unhexlify('4AA952327FEA5973E7E18B8A871C10F6')
app_swkey = ubinascii.unhexlify('9CF116015448CAF2996B7228469CBC6A')
...
def go_to_sleep(seconds):
    print("Im going to sleep for {} seconds...".format(seconds))
    time.sleep(seconds)
